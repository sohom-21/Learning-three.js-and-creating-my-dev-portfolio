...
const Navbar = () => {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 hover:border border-white/20 bg-white/0 backdrop-blur-sm font-medium transition hover:bg-white/5 hover:text-white shadow-lg">
