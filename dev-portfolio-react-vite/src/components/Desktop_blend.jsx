...
const Desktop_blend = ({ floorColor = '#000000', ...props }) => {
    const { nodes, materials } = useGLTF('/models/computer5.glb')

    // create/cloned floor material so we don't mutate shared material
    const floorMaterial = useMemo(() => {
        const base = nodes.Plane?.material ? nodes.Plane.material.clone() : new THREE.MeshStandardMaterial()
        base.color = new THREE.Color(floorColor)
        base.roughness = 0.8
        base.metalness = 0.0
        return base
    }, [nodes.Plane, floorColor])

    useEffect(() => {
        return () => {
            // dispose cloned material on unmount
            if (floorMaterial && floorMaterial.dispose) floorMaterial.dispose()
        }
    }, [floorMaterial])
    ...
    return (
        <group {...props} dispose={null}>
            <mesh
                ...
                material={floorMaterial} // <- use cloned material with chosen color
